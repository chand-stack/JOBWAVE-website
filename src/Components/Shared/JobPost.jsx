...
const JobPost = () => {
    ...
    <div className='text-white space-y-5'>
                ...
                So Many People Are <span className='text-[#A582F7]'>Engaged</span><br /> All Over The World
                    Work With  Companies</h1>
                <p>Global engagement unites countless individuals from diverse cultures, forming a vibrant tapestry of humanity.!</p>
                <button className='btn bg-gradient-to-t from-[#7367F0] from-10% via-[#A582F7] via-30% to-[#CE9FFC] to-90% border-none text-white'>Post A Job</button>
