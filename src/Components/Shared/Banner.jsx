  ...
  return (
    <div className="h-screen text-white relative text-center">
      <div className="flex justify-center items-center h-full">
        <div className="z-20">
          <h1 className="text-4xl md:text-7xl lg:text-9xl font-black ">
            One step closer to <br />
            your dream job
          </h1>
          <p className="md:text-3xl font-medium my-10">
      ...
      <div className="">
        <img
          className="rotate-45 transform-gpu w-28 md:w-52 absolute top-1/3 left-1/4 opacity-60 z-10"
          src={img}
          alt=""
        />
        <img
          className="-rotate-45 transform-gpu w-28 blur-sm md:w-52 absolute bottom-1/4 right-1/4 opacity-60 z-10"
          src={img}
          alt=""
        />
        <img
          className="-rotate-45 transform-gpu w-20 md:w-36 blur-sm absolute top-3/4 left-1/4 opacity-60 z-10"
          src={img}
          alt=""
        />
