    ...
    <div className="container mx-auto flex flex-col-reverse md:flex-row gap-5 md:gap-0 items-center my-32">
      ...
      <div className="text-white space-y-5">
        <h1 className="text-3xl md:text-4xl font-black">
          Work With <span className="text-[#A582F7]">Exciting</span>
          <br /> Companies
        </h1>
        <p>
          Discover career opportunities with exciting, innovative companies.{" "}
          <br /> Elevate your career with us today!
        </p>
