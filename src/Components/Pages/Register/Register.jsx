...
const Register = () => {
  ...
  const registerHandler = (e) => {
    ...
    if (passowrd.length < 6) {
      Swal.fire("", "Password must be at least 6 characters long!", "error");
      return;
    }
            ...
            <div className="card  w-full shadow-2xl border-2 border-[#A582F7] max-w-md flex-grow bg-[#111]">
              ...
              <form onSubmit={registerHandler} className="card-body ">
                <div className="form-control">
                  <label className="label">
                    <span className="label-text text-white flex items-center gap-1">
                      <BiSolidUser className="text-[#A582F7] text-2xl" /> Name
                    </span>
                  </label>
                  <input
                    type="text"
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text text-white flex items-center gap-1">
                      <MdAddPhotoAlternate className="text-[#A582F7] text-2xl" />
                      Photo Url
                    </span>
                  </label>
                  <input
              ...
              <div className="text-center pb-3 space-y-2">
                ...
                <button
                  ...
                  className=" btn btn-outline text-[#A582F7]"
                >
